...
export const Quejas = () => {
  ...
  Opciones de quejas
      ...
      >
        ...
        <option>
        FW- Formulación incorrecta
        </option>
        <option>
         LD- Dureza del pellet
        </option>
        <option>
         ME- Materia extraña en el alimento
        </option>
        <option>
         PH - Producto enmohecido
        </option>
      </Input>
  </FormGroup>
        <Label
  ...
  <FormGroup>
    <Label for="exampleEmail">
      Detalle del producto y/o factura
    </Label>
  </FormGroup>
